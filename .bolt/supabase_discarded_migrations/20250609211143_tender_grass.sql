/*
  # Add legal documents to CMS

  1. New Content
    - Add privacy policy, terms of service, and cancellation policy content to cms_content table
    - Support multiple languages (en, ru)
    - Each document has a unique slug for easy retrieval

  2. Structure
    - Each document is broken into sections for better management
...
Please contact us as soon as possible if you're running late or unable to attend.', 'No-show policy information', 'en', true),
