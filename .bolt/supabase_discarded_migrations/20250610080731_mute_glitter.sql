...
Получая доступ и используя услуги, предоставляемые Garda Racing Yacht Club ("мы", "наш" или "нас"), вы принимаете и соглашаетесь соблюдать условия и положения настоящего соглашения.', 'Принятие условий', 'ru', true),
